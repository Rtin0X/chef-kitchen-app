                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Nous Contactez ?</p>
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            ...
                                            <div className="sm:col-span-2">
                                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Ecrire un message</label>
                                                <textarea
                                                    id="message"
                                                    name="input3"

...
const products: ProductType[] = [
    {
        id: 1,
        section: "Company",
        link: ['A propos', 'Carrieres', 'Mobile', 'Blog', 'Savoir-faire'],
    },
    {
        id: 2,
        section: "Contact",
        link: ['FAQ', 'Infos', 'Affiliations', 'Partenaires']
    }
    ,
    {
        id: 3,
        section: "Plus",
        link: ['Recettes', 'Chefs', 'Ingredients', 'Support']
    }
]
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    ...
                    <h3 className='text-textbl text-xs font-medium mt-5 mb-4 lg:mb-16'> </h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2024 - Chef&apos;s kitchen. Tous les droits sont réservés par Samy</h4>
                <div className="flex gap-5 mt-5 md:mt-0 justify-center md:justify-start">
                    <h4 className='text-darkgrey text-sm font-normal'><Link href="/" target="_blank">Vie Privée</Link></h4>
                    <div className="h-5 bg-bordertop w-0.5"></div>
                    <h4 className='text-darkgrey text-sm font-normal'><Link href="/" target="_blank">Termes & Conditions</Link></h4>
                </div>
            </div>
        </div>
    )
